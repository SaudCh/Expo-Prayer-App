...
export default function App(props) {
  ...
  const { method } = propsroute.params;
  ...
  async function load() {
    try {
      ...
      const apiURL = `${PRAYER_API_URL}city=${city}&country=Pakistan&method=1`
      ...
      <View style={styles.container}>
        ...
        <ScrollView >
          ...
          <View style={{ ...styles.timing }}>
            ...
            <Text style={{ ...styles.text }}>{data.data[date].timings.Imsak}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Fajar</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Fajr}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Sunrise</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Sunrise}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Duhar</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Dhuhr}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Asr</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Asr}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Sunset</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Sunset}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Maghrib</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Maghrib}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Ishaa</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Isha}</Text>
          </View>
          <View style={{ ...styles.timing }}>
            <Text style={{ ...styles.text }}>Mid Night</Text>
            <Text style={{ ...styles.text }}>{data.data[date].timings.Midnight}</Text>
          </View>
